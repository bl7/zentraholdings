              ...
              <form className="space-y-6" onSubmit={handleSubmit} ref={formRef}>
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      id="firstName"
                      name="firstName"
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#4A164B] focus:border-transparent transition-colors text-black"
                      placeholder="John"
                      required
                    />
                  </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    name="message"
                    rows={6}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#4A164B] focus:border-transparent transition-colors resize-none text-black"
                ...
                <button
                  type="submit"
                  className="w-full px-8 py-4 bg-[#4A164B] text-white rounded-lg hover:bg-[#3a1239] transition-colors font-semibold text-lg disabled:opacity-60 disabled:cursor-not-allowed"
                  disabled={loading}
                >
            ...
            <div>
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start space-x-4">
                  <div className="w-12 h-12 bg-gradient-to-br from-[#4A164B] to-[#9321C6] rounded-xl flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      <a href="mailto:hello@zentraholdings.com" className="text-[#4A164B] hover:text-[#3a1239] transition-colors">
                        hello@zentraholdings.com
                      </a>
                    </p>
                    <p className="text-gray-700">
                      <a href="mailto:support@zentraholdings.com" className="text-[#4A164B] hover:text-[#3a1239] transition-colors">
                        support@zentraholdings.com
                      </a>
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      <a href="tel:+44-20-1234-5678" className="text-[#4A164B] hover:text-[#3a1239] transition-colors">
                        +44 20 1234 5678
                      </a>
                    </p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <div className="flex space-x-4">
                      <a href="#" className="text-[#4A164B] hover:text-[#3a1239] transition-colors">
              ...
              <div className="mt-12">
                ...
                <div className="space-y-4">
                  {/* Collapsible FAQ - React stateful implementation */}
                  {/* Place this inside the Contact component */}
                  {/* FAQ DATA */}
                  {(() => {
                    const faqs = [
                      {
      ...
      >
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-700">
              We welcome partners and clients to our London headquarters by appointment.
            </p>
          </div>
          {/* Placeholder for Map */}
          <div className="bg-white shadow-lg overflow-hidden">
            <div className="h-96 bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-gray-500">123 Innovation Drive, London, UK</p>
